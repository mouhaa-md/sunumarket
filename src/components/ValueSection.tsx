        ...
        {valueProps.map((prop, index) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-6 group-hover:gradient-text transition-all duration-300 whitespace-pre-line">{prop.title}</h3>
